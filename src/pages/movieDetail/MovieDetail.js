...
const MovieDetail = () => {
    ...
    const getData = () => {
        fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=6445e0c7dedebaf10e6800dfe34257c6&language=en-US`)
        .then(res => res.json())
    ...
    return (
        <div className="movie"  >
            <div className="movie__intro">
                <img className="movie__backdrop" src={`https://image.tmdb.org/t/p/original${currentMovieDetail ? currentMovieDetail?.backdrop_path : ""}`} alt="Loading IMG" />
            </div>
            ...
            <div className="movie__detail">
                ...
                <div className="movie__detailLeft">
                    <div className="movie__posterBox">
                        <img className="movie__poster" src={`https://image.tmdb.org/t/p/original${currentMovieDetail ? currentMovieDetail.poster_path : ""}`} alt="Loading IMG" />
                    </div>
                </div>
                        ...
                        <>
                            {
                                ...
                                <span className="productionCompanyImage">
                                    <img className="movie__productionComapany" src={"https://image.tmdb.org/t/p/original" + company.logo_path} alt="Loading IMG"/>
